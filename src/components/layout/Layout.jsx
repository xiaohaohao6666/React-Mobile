			...
			<div>
				...
				<div className="main-menu">
					<Grid centered padded>
						<Grid.Row columns={4}>
							<Grid.Column>
                                <MenuLink activeOnlyWhenExact={true} to="/layout/home" menuName="首页"  iconName='user secret'></MenuLink>
							</Grid.Column>
							<Grid.Column>
                                <MenuLink to="/layout/info" menuName="资讯" iconName='window restore'></MenuLink>
							</Grid.Column>
							<Grid.Column>
                                <MenuLink to="/layout/chat" menuName="微聊" iconName='microchip'></MenuLink>
							</Grid.Column>
							<Grid.Column>
                                <MenuLink to="/layout/mine" menuName="我的" iconName='window maximize'></MenuLink>
							</Grid.Column>
						</Grid.Row>
					</Grid>
				</div>
